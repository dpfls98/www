...
$(document).ready(function() {
    ...
    $('ul.dropdownmenu').hover(
       function() { 
          ...
          $('#headerArea').animate({height:195},'fast').clearQueue();
     });
     
     //1depth 효과
     $('ul.dropdownmenu li.menu').hover(
       function() { 
           $('.depth1',this).css('color','#c06');
       },function() {
...
$(document).ready(function() {
	...
	*/
	...
	//tab키 처리
	  $('.select .family').on('focus', function () {        
              $('.select .aList').show();	
       });
